...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnGallery,
      ...
      @NonNull TextView tvBrightness, @NonNull TextView tvContrast,
      @NonNull TextView tvSaturation) {
    ...
    this.tvSaturation = tvSaturation;
  }
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tv_saturation;
      TextView tvSaturation = ViewBindings.findChildViewById(rootView, id);
      if (tvSaturation == null) {
        break missingId;
      }

      return new ActivityMainBinding((ConstraintLayout) rootView, btnGallery, btnSave, ivPhoto,
          slBrightness, slContrast, slGamma, slSaturation, tvBrightness, tvContrast, tvSaturation);
    }
